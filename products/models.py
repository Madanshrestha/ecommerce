...
#Used for getting the file name and its extensions
...
#customizing the model manager to create our own model manager method by overriding to find the objects instead of using objects.filter
class ProductManager(models.Manager):
    ...
    def featured(self): #this function is used for writing Product.object.featured() instead of using .all().featured()
...
#For carrying out the operations before saving the data into database
